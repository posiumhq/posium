...
import type { WeeklyStatusData } from "../types.js";

export function WeeklyStatusEmail({
  userName,
  generatedAt,
  orgName,
  projects,
  ...
  return (
    <BaseLayout preview={`Weekly Status - ${orgName} - ${formattedDate}`}>
      <Section style={styles.content}>
        <Heading style={styles.heading}>Weekly Status</Heading>
        <Text style={styles.date}>{formattedDate}</Text>

        <Text style={styles.text}>Hi {userName},</Text>
        <Text style={styles.text}>
          Here&apos;s the weekly health summary for your projects in <strong>{orgName}</strong>:
        </Text>
...
export default function WeeklyStatusEmailPreview() {
  return (
    <WeeklyStatusEmail
      userName="John Doe"
