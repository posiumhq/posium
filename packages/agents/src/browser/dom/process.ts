import { generateXPathsForElement as generateXPaths } from "./xpathUtils.js";
import {
  canElementScroll,
  getNodeFromXpath,
...
(() => {
  ...
  interface BrowserAgentBackdoor {
  ...
  const backdoor: BrowserAgentBackdoor = {
  ...
  if (!("__browserAgent__" in window)) {
    Object.defineProperty(window, "__browserAgent__", {
      value: backdoor,
      enumerable: false,
      writable: false,
      configurable: false,
